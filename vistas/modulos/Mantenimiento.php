        ...
        <div class="modal-body">
          <div class="row">
              ...
              <div class="card card-info mb-3">
                <div class="card-header py-2">
                  <h3 class="card-title small">
                    <i class="fas fa-info-circle mr-1"></i>Información del Equipo
                  </h3>
                </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title border-bottom pb-2 text-info">
                  ...
                  <form id="formFinalizarMantenimiento" method="post">
                    ...
                    <div class="form-group mb-4">
                      <label class="font-weight-bold mb-3">Nivel de Gravedad:</label>
                    ...
                    <div class="form-group mb-4">
                      <label for="descripcionProblema" class="font-weight-bold mb-2">
